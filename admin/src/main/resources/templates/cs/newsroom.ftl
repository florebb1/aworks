            ...
            <div class="col">
                <div class="breadcrumb-wrap mb-3">
                    <div class="form-row">
                        ...
                        <div class="col-auto">
                            <button type="button" class="btn btn-primary btn-block" data-toggle="modal" data-target="#noticeModal" data-seq="">뉴스룸 등록</button>
                        </div>
                    </div>
                </div>
...
<script src="/assets/js/page/cs/newsroomList.js"></script>
<!-- custom script 위치 -->

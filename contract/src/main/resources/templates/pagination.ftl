...
<#--<li ${attributes}><a href="?page=${pageNumber}<#if RequestParameters.sub?exists>&sub=${RequestParameters.sub}</#if><#if RequestParameters.slug?exists>&slug=${RequestParameters.slug}</#if>">${text?html}</a></li>-->
    <li ${attributes}><a href="javascript:paging(${pageNumber});" class="page-link">${text?html}</a></li>
</#macro>
...
<#macro nextHtml pageNumber text = "" attributes = "">
    ...
    <li ${attributes}><a href="javascript:paging(${pageNumber});" class="page-link"><i class="mdi mdi-skip-next"></i></a></li>
</#macro>
...
<#macro previousHtml pageNumber text = "" attributes = "">
    ...
    <li ${attributes}><a href="javascript:paging(${pageNumber});" class="page-link"><i class="mdi mdi-skip-previous"></i></a></li>
</#macro>

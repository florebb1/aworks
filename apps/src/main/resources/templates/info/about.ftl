...
<section class="sub-hero d-flex flex-column justify-content-center align-items-center">
    <h1><@spring.message "about.text1"/></h1>
    <div><@spring.message "about.text2"/></div>
</section>
...
<section class="place-wrap">
    <div class="container mb-5">
        <div class="row text-center">
            <div class="col">
                <a class="btn btn-outline-info border-radius-none btn-lg mb-5" href="#" role="button"><@spring.message "about.text3"/></a>
            </div>
        </div>
    </div>
</section>

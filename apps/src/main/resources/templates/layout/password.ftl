...
<body style="height: 100%; margin: 0; background-color: #f8f8f8; padding-top: 9%; padding-bottom: 16%;">
<table width="100%" cellspacing="0" cellpadding="0" style="min-width: 360px; max-width: 700px; margin: auto;">
    <tr>
        <td>
    ...
    <tr>
        <td>
            <table width="100%" cellpadding="0" cellspacing="0" style="background-color: #fff; padding-top: 39px; padding-left: 40px; padding-right: 40px; margin-top: 20px; min-width: 360px;">
                <tr>
                ...
                <tr>
                    <td style="padding-bottom: 83px;">
                        <div style="width: 80%; margin: auto; padding-top: 25px; padding-bottom: 40px; padding-left: 25px; padding-right: 25px; box-shadow: 40px 40px 35px -40px rgba(0, 0, 0, 0.21);">
                            <p>비밀번호 초기화 정보</p>
